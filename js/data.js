...
const EXERCISES = {
  ...
  manhood: {
    ...
    exercises: [
      ...
      {
        id: 'stroke-stretch-combo', name: 'Stroke & Stretch', subtitle: 'Allungamento integrato nella masturbazione',
        icon: '↕️', difficulty: 'Principiante', difficultyLevel: 1, xp: 20,
        target: 'Lunghezza, Legamento sospensore', duration: '15-20 min', sets: 1, reps: 'Sessione', holdTime: 20,
        unlockLevel: 1,
        benefits: ['Unisce piacere e allenamento senza tempo extra', 'Sfrutta l\'eccitazione per tessuti più elastici', 'Facile da inserire nella routine normale'],
        steps: [
          'Scalda 5 minuti con un panno caldo (facoltativo ma consigliato)',
          'Lubrifica bene',
          'Inizia a masturbarti con il ritmo che preferisci',
          'Ogni 20-30 movimenti, FERMATI in cima (alla massima estensione) e tieni la presa ferma, tirando leggermente verso l\'esterno',
          'Mantieni questa trazione leggera per 15-20 secondi',
          'Rilascia, riprendi il ritmo normale per un\'altra serie di movimenti',
          'Ripeti il ciclo movimento + pausa-stretch per tutta la sessione',
          'Puoi finire con o senza orgasmo, entrambi vanno bene — fallo 3-4 volte a settimana'
        ],
        tips: 'L\'eccitazione porta più sangue nei tessuti, rendendoli naturalmente più elastici: è un buon momento per uno stretch leggero. Se durante la pausa perdi un po\' di erezione è normale, riprendi il ritmo. La trazione deve essere leggera, mai dolorosa.'
      },
      {
        id: 'girth-squeeze-stroke', name: 'Girth Squeeze Stroke', subtitle: 'Presa per la circonferenza durante la masturbazione',
        icon: '🤏', difficulty: 'Intermedio', difficultyLevel: 2, xp: 25,
        target: 'Girth, Pressione interna', duration: '15-20 min', sets: 1, reps: 'Sessione', holdTime: 5,
        unlockLevel: 1,
        benefits: ['Aumenta la pressione nei tessuti durante l\'attività', 'Stimola la circonferenza senza sessioni PE separate', 'Facile da alternare con lo stroke normale'],
        steps: [
          'Lubrifica bene mani e zona',
          'Forma un anello con pollice e indice ALLA BASE',
          'Stringi moderatamente (non al massimo) mentre fai il movimento verso l\'alto — la stretta trattiene il sangue e aumenta la pressione nel corpo',
          'In cima, mantieni la stretta per 5 secondi prima di tornare giù',
          'Alterna: 10 movimenti con stretta alla base, poi 10 movimenti normali senza stretta, per non perdere sensibilità',
          'Ripeti i cicli per tutta la sessione',
          'Se senti pizzicore acuto o vedi rossore/lividi, allenta subito la presa',
          'Massimo 4 volte a settimana'
        ],
        tips: 'La pressione alla base funziona un po\' come un cock ring leggero: trattiene più sangue nella parte centrale e superiore, aumentando temporaneamente la circonferenza. Non sostituisce jelqing e Uli squeeze dedicati, ma è un modo per aggiungere stimolo senza tempo extra.'
      },
      {
...
const ROUTINE_ALTERNATIVES = {
  ...
  manhood: [
    ...
    { id: 'stroke-stretch-combo', name: 'Stroke & Stretch', desc: 'Allungamento durante la masturbazione', default: false },
    { id: 'girth-squeeze-stroke', name: 'Girth Squeeze Stroke', desc: 'Circonferenza durante la masturbazione', default: false },
